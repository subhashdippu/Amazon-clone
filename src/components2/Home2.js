    ...
    return (
        <Container className='ContainerPart1'>
            ...
            <Content className='ContentPart1'>
                ...
                <LogPart className='for-Selling'>
                    <h2 className='text-for-register'>
                        Get 50% off on Selling Fee*
                        <h6>
                            Become a Seller
                        </h6>
                    </h2>
                    <img className='Image-for-regisration' src='https://images-eu.ssl-images-amazon.com/images/G/31/amazonservices/landing/ATF-imagery-cardv2._CB601720007_.jpg' />
